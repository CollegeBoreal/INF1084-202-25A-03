...
git branch -M main
git remote add origin https://github.com/hachemdsq/TP_Services_AD.git
...
**Author:** Hachem Souyadi
**Course:** INF1084 – Systèmes d’exploitation
**Institution:** Collège Boréal
**Session:** Automne 2025
**Instructor:** Jean-Marc Palm

---

## ✅ Conclusion

This documentation consolidates theoretical knowledge and practical automation of **Windows and Active Directory services**.
All PowerShell scripts demonstrate operational control, dependency awareness, and administrative precision expected from a professional system engineer.
