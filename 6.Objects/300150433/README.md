...
$OU = "OU=Students,DC=DC300150433-00,DC=local"
New-GPLink -Name $GPOName -Target $OU

$DriveLetter = "Z:"
$SharePath = "\\DC300150433-00\SharedResources"
...
* Connexion avec **Etudiant1** ou **Etudiant2** :
  ...
  * Le lecteur Z: est mappé vers `\\DC300150433-00\SharedResources`
...
J’ai pu mettre en pratique la création d’un partage réseau, la configuration de stratégies de groupe et l’accès distant (RDP) en environnement de domaine.
