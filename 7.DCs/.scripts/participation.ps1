...
foreach ($id in $GROUPES) {
    ...
    $OK = "| $i | [$id](../$FILE) :point_right: $URL1 - $URL2 | :heavy_check_mark: | :x: |"
    $FULL_OK = "| $i | [$id](../$FILE) :point_right: $URL1 - $URL2 | :heavy_check_mark: | :heavy_check_mark: |"
    $KO = "| $i | [$id](../$FILE) :point_right: $URL1 - $URL2 | :x: | :x: |"
